...
Сайт дауыс беру алдында Kaspi төлем сілтемесін ашады және 500 ₸ төлем flow-ын көрсетеді. Әр дуэльдің 1-өңірі мен 2-өңірі үшін бөлек Kaspi ИП сілтемесін (`kaspiLink1`, `kaspiLink2`) орнатуға болады — әр өңірге дауыс берушілер өз ИП-ына төлейді. Бірақ нақты төленген соманы автоматты тексеру үшін Kaspi ресми merchant/API интеграциясы қажет. Онсыз браузер немесе сервер Kaspi ішіндегі нақты соманы көре алмайды.
